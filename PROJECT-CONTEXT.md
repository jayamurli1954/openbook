...
- ADR-0028 established the release/compliance evidence layer; Gate 5/6 runtime inventory and Gate 6 font OFL clearance are populated under evidence ops; broader npm population and FOUNDATION-READY remain open.
...
- Whether `FOUNDATION-READY` / `FOUNDATION-GOVERNANCE-READY` can be declared — **not declared** (post–Gate 10 closure; evidence ops Slice 2 in progress)
- Foundation readiness evidence ops — **selected**; Slice 1 done (PR #110); Slice 2 records Gate 6 font OFL clearance; npm inventory still deferred
...
- Broader production dependency inventory beyond Gate 5/6 runtimes and Gate 6 fonts
...
- `docs/release-compliance/evidence-inventory.json` (Slice 1–2 population)
