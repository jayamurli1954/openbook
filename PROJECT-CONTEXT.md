...
- ADR-0034 accepts Phase 1 Writing Studio architecture; Slices 1–3 are done (PRs #124–#126); Slice 4 (image insertion) is authorized separately — see `docs/adr-0034-slice-4-image-insertion.md`.
...
- Phase 1 Writing Studio — **ADR-0034 Accepted**; Slices 1–3 done (PRs #124–#126); Slice 4 (image insertion) authorized — see `docs/adr-0034-slice-4-image-insertion.md`
