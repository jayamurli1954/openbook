...
- ADR-0032 accepts Gate 10 desktop packaging / release readiness (packaged-resource locator; Windows-first bundle of Gate 5/6 runtimes). Slice 4 is the current authorized implementation unit.
...
- Packaging / release readiness — **Accepted** (Gate 10 / ADR-0032; Slice 4 in progress)
