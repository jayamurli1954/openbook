...
├── Slice 3 desktop host wiring            [IN PROGRESS — locator → validator/PDF host]
...
├── Packaging / release readiness          [ADR-0032 Accepted; Slice 3 in progress]
│
...
| **Packaging / release readiness** | A developer `.cache/` runtime is not a shippable desktop product. | ADR-0032 **Accepted**. Slices 1–2 done. Slice 3 in progress. | Complete Slice 3. Slices 4–5 remain separately gated. |
...
Gates 1 through 9, ADR-0028's five implementation slices, ADR-0029 Slices 1–6, and ADR-0031 Slices 1–5 are complete on `main`. Gate 10 ADR-0032 is **Accepted**. Slices 1–2 are done (PR #104, #105). Slice 3 (desktop host wiring) is the current authorized unit.
