...
├── Evidence ops Slice 3 (direct npm)      [IN PROGRESS — desktop path direct deps; transitive/Cargo unresolved]
│
...
Gates 1 through 10, ADR-0028's five implementation slices, ADR-0029 Slices 1–6, ADR-0030 Slices 1–5, and ADR-0031 Slices 1–5 are complete on `main`. Gate 10 ADR-0032 Slices 1–5 are done (PRs #104–#108). `FOUNDATION-READY` is **not** declared; see `docs/FOUNDATION-READINESS-POST-GATE-10-CLOSURE.md`. The selected next path is **foundation readiness evidence ops** (`docs/FOUNDATION-READINESS-EVIDENCE-OPS-SELECTION.md`); Slices 1–2 (PRs #110–#111) covered Gate 5/6 runtimes and Gate 6 fonts; Slice 3 records direct production npm deps without declaring FOUNDATION-READY.
