...
├── Domain selection + ADR-0034            [DONE — PR #123]
├── ADR-0034 Slice 1 (contract)            [DONE — PR #124]
├── ADR-0034 Slice 2 (formatting chrome)   [DONE — PR #125]
├── ADR-0034 Slice 3 (word count/search)   [IN PROGRESS — this PR]
│
