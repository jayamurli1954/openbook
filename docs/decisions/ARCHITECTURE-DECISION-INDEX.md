...
| ADR-0034 | Phase 1 — Writing Studio Architecture | Accepted; Slices 1–2 authorized (further slices gated) | Desktop / Phase 1 MVP / Writing Studio | 2026-09-24 |
...
- **Selected next product path:** Phase 1 Writing Studio — ADR-0034 **Accepted**; Slices 1–2 authorized; further slices gated — see `docs/PHASE-1-WRITING-STUDIO-SELECTION.md`
...
ADR-0034 (Writing Studio) is **Accepted**. Slice 1 (contract) is **done** (PR #124). Slice 2 (formatting chrome) is authorized on this follow-on; further implementation slices remain separately gated — see `docs/adr-0034-slice-2-formatting-chrome.md`.
