...
| ADR-0027 | Security Disclosure and Vulnerability Response Governance | Accepted | Governance / Security / Contributor Readiness | 2026-09-15 |
...
- ~~Security disclosure and vulnerability response governance~~ — ADR-0027 **Accepted**; implementation remains separately gated
