...
| ADR-0024 | Developer Certificate of Origin 1.1 contribution sign-off | Proposed | Governance / Licensing / Contributor Readiness | 2026-09-15 |
...
- Bundled-font policy
- ~~Contributor agreement mechanism (CLA/DCO)~~ — DCO 1.1 proposed by ADR-0024; acceptance and enforcement implementation remain separately gated
