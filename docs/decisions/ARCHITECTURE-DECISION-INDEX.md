...
| ADR-0033 | Phase 1 — Book Wizard / Guided Start Architecture | Accepted; implementation requires separate explicit authorization | Desktop / Phase 1 MVP / Guided Start | 2026-09-24 |
...
- **Selected next product path:** Phase 1 Book Wizard / Guided Start — ADR-0033 **Accepted**; implementation not authorized — see `docs/PHASE-1-NEXT-DOMAIN-SELECTION.md`
- AI/Ollama and DTP/page layout remain future work and must not displace Phase 1 Book Wizard slices once authorized
...
ADR-0033 (Book Wizard / Guided Start) is **Accepted**. Implementation slices are **not** authorized by ADR acceptance alone — see `docs/PHASE-1-NEXT-DOMAIN-SELECTION.md`.
