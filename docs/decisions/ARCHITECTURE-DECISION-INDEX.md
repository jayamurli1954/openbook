...
| ADR-0025 | Project Stewardship & Maintainer Governance | Proposed | Governance / Contributor Readiness | 2026-09-15 |
...
- Bundled-font policy
- ~~Contributor agreement mechanism (CLA/DCO)~~ — resolved by ADR-0024: DCO 1.1 **Accepted**; enforcement implementation remains separately gated
- **Stewardship and maintainer governance** — proposed in ADR-0025; acceptance and any follow-on implementation remain separately gated
