...
| ADR-0027 | Security Disclosure and Vulnerability Response Governance | Proposed | Governance / Security / Contributor Readiness | 2026-09-15 |
...
- ~~Stewardship and maintainer governance~~ — resolved by ADR-0025: **Accepted**; follow-on governance implementation remains separately gated
- ~~Code of Conduct governance~~ — resolved by ADR-0026: **Accepted**; implementation remains separately authorized
- ~~Security disclosure and vulnerability response governance~~ — ADR-0027 **Proposed**; acceptance and implementation remain separately gated
