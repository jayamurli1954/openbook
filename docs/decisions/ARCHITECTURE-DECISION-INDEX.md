...
- **Selected next product path:** Phase 1 Writing Studio — ADR-0034 **Accepted**; Slices 1–3 authorized; further slices gated — see `docs/PHASE-1-WRITING-STUDIO-SELECTION.md`
...
ADR-0033 (Book Wizard / Guided Start) is **Accepted**. Slices 1–5 are **done** on `main` (PRs #117–#121). Sequencing is closed — see `docs/adr-0033-closure-reconciliation.md`.

ADR-0034 (Writing Studio) is **Accepted**. Slices 1–2 are **done** (PRs #124–#125). Slice 3 (word count + document search) is authorized on this follow-on; further implementation slices remain separately gated — see `docs/adr-0034-slice-3-word-count-search.md`.
