...
| ADR-0019 | Desktop Studio Integration Architecture (Gate 8) | Accepted; Slices 1–3 implemented; Slice 4 architecture accepted (ADR-0022), implementation gated; Slice 5 remains gated | Desktop / Workflow / Architecture | 2026-09-11 |
