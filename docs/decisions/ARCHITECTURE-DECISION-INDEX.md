...
- **Required next product capabilities (must not be dropped):** filesystem project package (ADR-0029 Slices 1–6 complete); autosave & crash recovery (ADR-0031 Slices 1–5 complete); Gate 9 export UI / native Save As (ADR-0030 complete). **Gate 10 packaging/release readiness:** ADR-0032 **Accepted**; Slice 3 (desktop host wiring) is the current authorized unit. See `docs/IMPLEMENTATION-BACKLOG.md`.
...
ADR-0032 is **Accepted**. Slices 1–2 are **done** (PR #104, #105). Slice 3 (desktop host wiring through the packaged locator) is authorized.
