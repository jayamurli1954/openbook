...
**Update (2026-09-24):** Phase 1 Book Wizard architecture is selected and ADR-0033 Accepted — see `docs/PHASE-1-NEXT-DOMAIN-SELECTION.md`. Book Wizard Slices 1–5 are done. Writing Studio is the next selected domain (ADR-0034 Accepted; implementation separately gated) — see `docs/PHASE-1-WRITING-STUDIO-SELECTION.md`.
