...
| [Foundation evidence ops selection](FOUNDATION-READINESS-EVIDENCE-OPS-SELECTION.md) | Selected next path: ADR-0028 evidence population (Slice 4: npm closure; FOUNDATION-READY not declared) |
...
| [Release/compliance](release-compliance/) | ADR-0028 evidence (Gate 5/6 + fonts + npm closure; Cargo deferred) |
